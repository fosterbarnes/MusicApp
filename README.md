...
If you want to use it, [download the latest release](https://github.com/fosterbarnes/musicApp/releases/download/v0.1.3/musicApp-v0.1.3-tummyExpert-portable.zip), unzip, then run MusicApp.exe
